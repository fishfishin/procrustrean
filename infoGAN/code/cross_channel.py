...
class CGAN():
    ...
    def build_generator(self):
        ...
        '''
        gen =Conv2DTranspose(128, kernel_size=4,strides=(2,2), padding="same")(merge)
        gen =LeakyReLU(alpha=0.2)(gen)
        #gen =BatchNormalization(momentum=0.8)(gen)

        gen =Conv2DTranspose(128, kernel_size=4,strides=(2,2), padding="same")(gen)
        gen =LeakyReLU(alpha=0.2)(gen)
        #gen =BatchNormalization(momentum=0.8)(gen)

        gen = Conv2DTranspose(64, kernel_size=4, strides=(2,2),padding="same")(gen)
        gen = LeakyReLU(alpha=0.2)(gen)
        #gen = BatchNormalization(momentum=0.8)(gen)
        
        gen = Conv2DTranspose(32, kernel_size=4,strides=(2,2),padding="same")(gen)
        gen = LeakyReLU(alpha=0.2)(gen)
        #gen = BatchNormalization(momentum=0.8)(gen)
    ...
    def sample_images(self, epoch,gen_imgs):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig.savefig("C:/Users/ZhenjuYin/Documents/Python Scripts/emotic/class/cgan/imagescc/%d.png" % epoch)
        plt.close()

    def save_model(self):

        def save(model, model_name):
            model_path = "C:/Users/ZhenjuYin/Documents/Python Scripts/emotic/class/cgan/%scc.json" % model_name
            weights_path = "C:/Users/ZhenjuYin/Documents/Python Scripts/emotic/class/cgan/%scc_weights.h5" % model_name
...
if __name__ == '__main__':
    ...
    #cgan.discriminator.load_weights("C:/Users/ZhenjuYin/Documents/Python Scripts/emotic/class/cgan/discriminatorcc_weights.h5")
    #cgan.generator.load_weights("C:/Users/ZhenjuYin/Documents/Python Scripts/emotic/class/cgan/generatorcc_weights.h5")
